...
// distFS stores the compiled dashboard assets generated by `npm run build` in ui/.
// ui/dist is intentionally not tracked in git and must exist before `go build`/`go test`.
//
//go:embed all:dist
var distFS embed.FS
